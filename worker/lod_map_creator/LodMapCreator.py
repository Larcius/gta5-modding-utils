...
class LodMapCreator:
    ...
    def prepareLodCandidates(self):
        lodCandidates = {
            ...
            "prop_tree_eucalip_01": LodCandidate(0.5, 0.28125, UV(0, 0), UV(0.5, 1), UV(0.5, 0), UV(1, 1)),
            ...
            "prop_tree_oak_01": LodCandidate(0.4765625, 0.453125, UV(0, 0), UV(1, 0.5), UV(0, 0.5), UV(1, 1), UV(0.46875, 0.75)),
